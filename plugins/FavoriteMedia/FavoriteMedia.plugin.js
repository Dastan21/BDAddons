			...
			return class FavoriteMedia extends Plugin {
				...
				patchChannelTextArea() {
					Patcher.after(ChannelTextArea, "render", (_, [props], returnValue) => {
						...
						if (!ChannelStore.getChannel(SelectedChannelStore.getChannelId()).type && !getPermissionsArray(Permissions.getChannelPermissions(ChannelStore.getChannel(SelectedChannelStore.getChannelId()))).includes(Number(PermissionsConstants.SEND_MESSAGES.toString()))) return;
